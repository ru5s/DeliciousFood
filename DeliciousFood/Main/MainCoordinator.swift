...
class MainCoordinator: Coordinator {
    ...
    func start() {
        ...
        setupViewControllers(vc: homeTabVC, title: "Главная", imageName: "home default", selectedImageName: "home selected")
        
        let searchTabVC = UIHostingController(rootView: SearchTabSwiftUIView(model: searchTabModel))
        setupViewControllers(vc: searchTabVC, title: "Поиск", imageName: "search default", selectedImageName: "search selected")
        
        let shoppingTabVC = UIHostingController(rootView: ShoppingTabSwiftUIView(model: shoppingTabModel))
        setupViewControllers(vc: shoppingTabVC, title: "Корзина", imageName: "shopping default", selectedImageName: "shopping selected")
        
        let accauntTabVC = UIHostingController(rootView: AccauntTabSwiftUIView(model: accauntTabModel))
        setupViewControllers(vc: accauntTabVC, title: "Аккаунт", imageName: "cart accaunt default", selectedImageName: "cart accaunt selected")
